...
export function ActivitiesCard() {
  ...
  return (
    <>
      ...
      {open && (
        <div className="fixed inset-0 z-[70] flex items-center justify-center bg-slate-950/60 p-4 backdrop-blur-sm" role="dialog" aria-modal="true" aria-label={editingId ? 'Editar actividad' : 'Nueva actividad'}>
          <Card className="w-full max-w-xl overflow-hidden rounded-2xl border-border bg-background shadow-2xl">
