...
const copy = {
  es: {
    ...
    appearance: 'Apariencia', appearanceDescription: 'Esta preferencia se conserva en este dispositivo.',
  ...
  en: {
    ...
    appearance: 'Appearance', appearanceDescription: 'This preference is stored on this device.',
...
export function PreferencesProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    const onStorage = (event: StorageEvent) => {
      if (event.key === THEME_KEY) setThemeState(getThemePreference())
      if (event.key === LOCALE_KEY) setLocaleState(getLocalePreference())
    }
