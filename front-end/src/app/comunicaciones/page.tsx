...
function textos(english: boolean) {
  return english
    ? {
        ...
        eventoProgramadoLos: 'Event successfully scheduled. Participants in the project will see it in their calendar.',
        losEventosDel: 'Programme events are published automatically in participants’ calendars.',
    ...
    : {
        ...
        eventoProgramadoLos: 'Evento programado exitosamente. Los participantes del proyecto lo verán en su calendario.',
        losEventosDel: 'Los eventos del programa se publican automáticamente en el calendario de los estudiantes.',
