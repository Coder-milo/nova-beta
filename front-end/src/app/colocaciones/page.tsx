...
export default function ColocacionesPage() {
  ...
  return <div className="space-y-5">
    <div className="flex flex-wrap items-center justify-between gap-3"><div><p className="text-sm text-muted-foreground">{T.seguimientoDeEmpleabilidad}</p><p className="text-sm text-muted-foreground">Vinculaciones verificadas, condiciones laborales y checklist de ingreso.</p></div><Button onClick={abrirRegistro}><Plus /> Registrar colocación</Button></div>
