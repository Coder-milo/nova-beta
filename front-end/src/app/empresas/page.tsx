...
/** El valor viaja al backend; la etiqueta es interfaz y sale del diccionario. */
function estadosDeRelacion(T: ReturnType<typeof textos>): Array<{ valor: EstadoRelacionEmpresa; etiqueta: string }> {
  return [
    { valor: 'SIN_CONTACTAR', etiqueta: T.sinContactar },
    { valor: 'CONTACTADA', etiqueta: T.contactada },
    { valor: 'PERFIL_ENVIADO', etiqueta: T.perfilEnviado },
    { valor: 'EN_CONVERSACION', etiqueta: T.enConversacion },
    { valor: 'ALIADA', etiqueta: T.aliada },
    { valor: 'DESCARTADA', etiqueta: T.descartada },
  ]
}
...
export default function EmpresasPage() {
  ...
  const estados = estadosDeRelacion(T)
