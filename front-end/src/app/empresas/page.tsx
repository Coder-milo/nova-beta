...
export default function EmpresasPage() {
  ...
  return <div className="space-y-5">
    <div className="flex flex-col justify-between gap-3 sm:flex-row sm:items-center">
      <div><p className="text-sm text-muted-foreground">{T.directorioYRelacionamiento}</p><p className="mt-1 text-sm text-muted-foreground">Organiza sectores, empresas vinculadas y el siguiente paso de cada contacto.</p></div>
