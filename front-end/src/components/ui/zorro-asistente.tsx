 ...
 *
 * <p><strong>Vuelve a ser plano.</strong> Durante un tiempo el personaje se
 * dibujó en 3D con Three.js, con caída a SVG cuando no había WebGL. Eran 600 KB
 * de librería y un canvas compositando en cada fotograma —permanentemente, en
 * todas las pantallas— a cambio de un adorno; y obligaba a mantener dos
 * versiones del mismo personaje que había que retocar a la vez. Se recupera el
 * zorro plano original: pesa lo que pesa su SVG, no puede fallar por falta de
 * WebGL y no hay una segunda versión que se quede atrás.
 */
 ...
 * (ver `usar-ancla-del-zorro`), así que baja con él al volver al botón plano.
 */
export const TAMANO_Y = 60
  ...
  return (
    <button
      ...
      className={cn(
        ...
        'border border-primary/25 bg-card/95 shadow-[0_10px_30px_rgba(0,0,0,0.18)]',
