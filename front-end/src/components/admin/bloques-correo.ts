...
export const PERFILES_SIMULACION_PREDETERMINADOS: PerfilSimulacion[] = [
  {
    ...
    variables: {
      ...
      patrocinadores: 'Fundación Santo Domingo · CAC Eurocentres',
      aliados_proyecto: 'Alianzas Estratégicas y Cooperación Internacional',
      institucion_nombre: 'Academy CAC',
