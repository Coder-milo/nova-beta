...
function textos(english: boolean) {
  return english
    ? {
        titulo: 'Custom report generator',
        desc: 'Select the required fields to export a customized Excel report.',
        columnas: 'Columns',
        deLaFicha: 'Academic and profile data',
        personales: 'Contact and identification data',
        avisoPersonal:
          'Data privacy notice: These columns contain personal and contact details subject to data protection policies.',
        filtros: 'Filters',
        programa: 'Programme',
        ciudad: 'City',
        ...
        ninguna: 'Select at least one column.',
        limpiar: 'Clear',
        todasLasDeLaFicha: 'Select profile fields',
        descargando: 'Generating report…',
        conPersonales: (n: number) =>
          `${n} of them contain personal contact details`,
        fallo: 'The report could not be generated.',
        cargando: 'Loading column catalogue…',
      }
    : {
        titulo: 'Generador de reportes personalizados',
        desc: 'Selecciona los campos deseados para exportar un reporte a la medida en Excel.',
        columnas: 'Columnas',
        deLaFicha: 'Datos académicos y de perfil',
        personales: 'Datos de contacto e identificación',
        avisoPersonal:
          'Aviso de privacidad: Estas columnas contienen datos personales y de contacto sujetos a políticas de protección de datos.',
        filtros: 'Filtros',
        programa: 'Programa',
        ciudad: 'Ciudad',
        estado: 'Estado académico',
        todos: 'Todos',
        elegidas: (n: number) => `${n} seleccionadas`,
        ninguna: 'Selecciona al menos una columna.',
        limpiar: 'Limpiar',
        todasLasDeLaFicha: 'Seleccionar campos de perfil',
        descargando: 'Generando reporte…',
        conPersonales: (n: number) =>
          `${n} de ellas contienen datos personales de contacto`,
        fallo: 'No se pudo generar el reporte.',
        cargando: 'Cargando catálogo de columnas…',
      }
}
