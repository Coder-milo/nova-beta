...
function textos(english: boolean) {
  return english
    ? {
        titulo: 'Update log',
        descripcion:
          'The last runs against the job portals. A portal whose selectors break does not fail: it answers 200 and returns zero, so what gives it away is a run of zeros, not a single one.',
        sinCorridas: 'No update has run yet.',
        actualizar: 'Refresh',
        nuevas: 'new',
        sinIngles: 'dropped, no English required',
        cerradas: 'closed',
        portales: 'Portals consulted',
        porPortal: 'Offers returned by each portal',
        sinRegistro: 'Not recorded for this run',
        enCero: 'returned nothing',
        errores: 'Errors',
        ...
        parcial: 'Partial',
        fallida: 'Failed',
        cargando: 'Loading the log…',
      }
    : {
        titulo: 'Registro de actualizaciones',
        descripcion:
          'Las últimas corridas contra los portales. Un portal cuyos selectores se rompen no falla: responde 200 y devuelve cero, así que lo que lo delata es una racha de ceros, no una sola.',
        sinCorridas: 'Todavía no se ha ejecutado ninguna actualización.',
        actualizar: 'Actualizar',
        nuevas: 'nuevas',
        sinIngles: 'descartadas por no pedir inglés',
        cerradas: 'cerradas',
        portales: 'Portales consultados',
        porPortal: 'Ofertas devueltas por cada portal',
        sinRegistro: 'No se registró en esta corrida',
        enCero: 'no trajo nada',
        errores: 'Errores',
