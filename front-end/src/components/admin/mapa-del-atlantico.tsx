...
function textos(english: boolean) {
  return english
    ? {
        titulo: 'Geographic distribution of participants',
        desc: 'Active participants by municipality in the department of Atlántico.',
        todos: 'All projects',
        proyecto: 'Project',
        participantes: 'participants',
        participante: 'participant',
        sinUbicar: 'Pending location / Other regions',
        sinUbicarPor: 'Outside the department of Atlántico',
        porQueFuera: 'Corresponds to participants residing in other departments or whose municipality is pending updating in their record.',
        sinDato: 'no municipality on record',
        ...
        nadie: '0 participants',
        corrige: 'Update in the participant file.',
        verGente: (n: number, m: string) => `View ${n} participants in ${m}`,
        pulsaParaVer: 'Select a municipality to view the list of participants.',
        enElMapa: 'located on the map',
        concentracion: (pct: number, m: string) => `${pct}% in ${m}`,
      }
    : {
        titulo: 'Distribución geográfica de participantes',
        desc: 'Participantes activos por municipio del departamento del Atlántico.',
        todos: 'Todos los proyectos',
        proyecto: 'Proyecto',
        participantes: 'participantes',
        participante: 'participante',
        sinUbicar: 'Ubicaciones pendientes o fuera del departamento',
        sinUbicarPor: 'Fuera del departamento del Atlántico',
        porQueFuera: 'Corresponde a participantes residentes en otros departamentos o con el municipio pendiente de actualizar en su ficha.',
        sinDato: 'sin municipio registrado',
        ...
        nadie: '0 participantes',
        corrige: 'Actualizar en la ficha del estudiante.',
        verGente: (n: number, m: string) => `Ver ${n} participantes en ${m}`,
        pulsaParaVer: 'Selecciona un municipio para ver el listado de participantes.',
        enElMapa: 'ubicados en el mapa',
