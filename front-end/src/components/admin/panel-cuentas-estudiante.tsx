...
function textos(english: boolean) {
  return english
    ? {
        creaElUsuario: 'Creates portal access for each active student and sends an email invitation to set their password. Username is their registered email.',
        cadaEstudianteDefine: 'For privacy and compliance, passwords are confidential, encrypted, and configured directly by the student.',
        seLesEnviara: 'Activation link will be emailed to participants.',
        enviarlesSuEnlace: 'Send activation email to participants',
        ningunEstudianteCoincide: 'No students match the current criteria.',
        cuentasDeAcceso: 'Student Portal Access Accounts',
        soloLosQue: 'Accounts already active',
        soloLosQueX: 'Participants without portal account',
        todosLosEstudiantes: 'All active participants',
        buscarPorNombre: 'Search by name or email…',
        noSeEnviara: 'No notification emails will be sent.',
        aQuien: 'Recipients',
        enviado: 'Sent',
        seleccionarA: (n: string) => `Select ${n}`,
        fueraDeLa: '(excluded by test recipient filter)',
        simulacionNoSe: 'Simulation completed — no accounts or emails created',
        eligeAlMenos: 'Select at least one participant.',
        simularNoCrea: 'Simulate creation',
        crearCuentasDe: 'Create portal accounts',
        soloLosQueXX: 'Manual participant selection',
        limpiarSeleccion: 'Clear selection',
        sinCorreoEn: 'No email registered in profile',
        sinCorreoEnX: 'no email registered',
        estudiantesActivos: 'active participants',
        noSeLe: 'Unavailable',
        yaTienenCuenta: 'account already active',
        yaTenianCuenta: 'account was active',
        yaTieneCuenta: 'Account already active',
        seCrearian: 'would be created',
        crearCuentas: 'Create accounts',
        sinCuenta: 'pending account',
        sinCuentaX: 'Pending account',
        todos: 'All',
      }
    : {
        creaElUsuario: 'Habilita el acceso al portal para cada participante activo y le envía un enlace de activación por correo electrónico. El usuario corresponde a su correo.',
        cadaEstudianteDefine: 'Por seguridad y cumplimiento normativo, las contraseñas son confidenciales, cifradas y definidas directamente por el estudiante.',
        seLesEnviara: 'Se enviará el enlace de activación por correo electrónico.',
        enviarlesSuEnlace: 'Enviar enlace de activación por correo',
        ningunEstudianteCoincide: 'Ningún participante coincide con los criterios de búsqueda.',
        cuentasDeAcceso: 'Cuentas de acceso al portal de estudiantes',
        soloLosQue: 'Con cuenta activa',
        soloLosQueX: 'Sin cuenta en el portal',
        todosLosEstudiantes: 'Todos los participantes activos',
        buscarPorNombre: 'Buscar por nombre o correo…',
        noSeEnviara: 'No se enviará ninguna notificación por correo.',
        aQuien: 'Destinatarios',
        enviado: 'Enviado',
        seleccionarA: (n: string) => `Seleccionar a ${n}`,
        fueraDeLa: '(excluido por filtro de pruebas)',
        simulacionNoSe: 'Simulación completada — sin modificaciones aplicadas',
        eligeAlMenos: 'Selecciona al menos un participante.',
        simularNoCrea: 'Simular creación',
        crearCuentasDe: 'Crear cuentas de acceso',
        soloLosQueXX: 'Selección manual de participantes',
        limpiarSeleccion: 'Limpiar selección',
        sinCorreoEn: 'Sin correo registrado en la ficha',
        sinCorreoEnX: 'sin correo registrado',
        estudiantesActivos: 'participantes activos',
        noSeLe: 'No disponible',
        yaTienenCuenta: 'cuenta ya activa',
        yaTenianCuenta: 'cuenta ya activa',
        yaTieneCuenta: 'Cuenta ya activa',
