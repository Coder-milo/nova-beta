...
import { vacantesApi, ApiCallError } from '@/lib/api'
              ...
              <div className="p-4 border-t border-border shrink-0 flex justify-end gap-2">
                {selected.urlAplicar && (
                  <Button asChild variant="default" size="sm">
                    <a href={selected.urlAplicar} target="_blank" rel="noopener noreferrer">
                ...
                {selected.urlOrigen && (
                  <Button asChild variant="outline" size="sm">
                    <a href={selected.urlOrigen} target="_blank" rel="noopener noreferrer">
